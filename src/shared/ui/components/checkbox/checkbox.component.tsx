...
export const Checkbox = ({
  ...
  return (
    <div className="flex items-center">
      <RadixCheckbox.Root
        className="flex size-[22px] appearance-none items-center justify-center rounded-[4px] bg-gray-100 shadow-[0_0_0_1px_black] outline-none hover:bg-gray-200 focus:shadow-[0_0_0_1px_gray]"
        id="c1"
        checked={checked}
